...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/NkBots/YukkiMusicBot",
)
...
YOUTUBE_DOWNLOAD_EDIT_SLEEP = int(getenv("YOUTUBE_EDIT_SLEEP", "15"))

# Time sleep duration For Telegram Downloader
TELEGRAM_DOWNLOAD_EDIT_SLEEP = int(getenv("TELEGRAM_EDIT_SLEEP", "15"))
